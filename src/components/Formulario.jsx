  ...
  return (
    <>
          ...
          <p className="text-xl mt-5 mb-10 text-center">
            Añade tu pacientes y {''} <span className="text-indigo-600 font-bold">Administralos</span>
          </p> 
    ...
    <form className="bg-white py-10 px-5 mb-10 lg:mb-5 shadow-md rounded-md" onSubmit={handleSubmit}>
        ...
        <div className="mb-5">
            <label htmlFor="email" className="text-gray-700 font-bold">Email del Propietario</label>
            <input type="email"  
                id="email"
